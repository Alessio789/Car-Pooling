...
public class BookingDao {
    ...
    public static List<Booking> findAll() {
        TypedQuery<Booking> typedQuery = em.createQuery("SELECT b FROM Booking b", Booking.class);
        List<Booking> bookingList = typedQuery.getResultList();
        return bookingList;
    }

    public static Booking findById(Long id) {
        TypedQuery<Booking> typedQuery = em.createQuery("SELECT b FROM Booking b WHERE b.id=:id", Booking.class);
